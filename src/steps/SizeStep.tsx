...
const SizeStep: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-800 mb-4">Select Frame Size</h2>
      <p className="text-gray-600 mb-6">
        Choose a standard frame size for your images. All images will be cropped to this size.
      </p>
...
const SizeOption: React.FC<SizeOptionProps> = ({ size, isSelected, onSelect }) => {
    ...
    >
      ...
      >
        <div className="w-full h-full flex items-center justify-center">
          <Maximize size={aspectRatio > 1 ? 24 : 16} className="text-gray-400" />
        </div>
      </div>
